...
const verify = async function (req, res, next) {
    const user = req.user;
    try {
        const response = await axios.get(variables.dbUrl + "recettes/" + req.params.id, variables.options);
...
const getAll = async function (req, res) {
    try {
        const response = await axios.get(variables.dbUrl + "recettes", variables.options);
...
const create = async function (req, res) {
    try {
        ...
        const response = await axios.post(variables.dbUrl + 'recettes', params, variables.options);
        const recette = fill(response);
        if (recette)
...
const patch = async function (req, res) {
    try {
        ...
        const response = await axios.patch(variables.dbUrl + "recettes/" + req.params.id, params, variables.options)
        const recette = fill(response);
...
const put = async function (req, res) {
    try {
        ...
        const response = await axios.put(variables.dbUrl + "recettes/" + req.params.id, params, variables.options)
        const recette = fill(response);
...
const remove = async function (req, res) {
    try {
        await axios.delete(variables.dbUrl + "recettes/" + req.params.id, variables.options)
